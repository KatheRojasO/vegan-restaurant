    ...
    <div className="App">
      <BrowserRouter>
        <Routes>
          ...
          <Route path='/dishes/:id' element={<Product categoryName={"dishes"} />} />
          <Route path='/drinks/:id' element={<Product categoryName={"drinks"} />} />
          <Route path='/desserts/:id' element={<Product categoryName={"desserts"} />} />
        </Routes>
      </BrowserRouter>
    </div>
  );
